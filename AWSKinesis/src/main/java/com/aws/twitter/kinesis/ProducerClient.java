...
import com.aws.twitter.model.Producer;
...
public class ProducerClient implements Producer {
	...
	private final static Logger logger = LoggerFactory.getLogger(ProducerClient.class);
	 ...
	 */
	public ProducerClient(String name, String streamName, int threads, Region region) {
	...
	public void stop() {
		...
		try {
			...
			logger.info(name + ": Exception when attempting to stop the client: " + e.getMessage());
		}
	}
